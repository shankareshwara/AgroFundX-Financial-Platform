    ...
    <div class = "container"  style = {{height : "auto"}}>
        ...
        <div className='registration'  style = {{marginTop:"42px"}}>
          ...
          <button style = {{marginLeft:"0px" , marginBottom:"23px"}} class = "ride"  onClick={() => navigate("/LoginAdmin")}><a class = "a">admin</a></button>
            ...
            <p style = {{    marginLeft: "60px", marginTop:"21px"}}>already have an account? <button onClick = { () => navigate("/Login")} class = "ride"><a class = "ab"style = {{marginTop:"10px" ,color:"blue"}}>sign in </a></button></p>
        </div>
        <div>
